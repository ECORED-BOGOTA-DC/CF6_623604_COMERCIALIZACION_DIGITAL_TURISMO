...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .d-flex.flex-wrap.mb-5
      img.col-lg-6.mb-4.mb-lg-auto.mx-auto(src="@/assets/curso/temas/tema1/img-1.jpg" style="max-width: 610px" alt="imagen decorativa")
      .col-lg-6.ps-lg-4
    ...
    p.mb-5 Para iniciar esta parte, es prudente mencionar que, para tener éxito en el desarrollo e implementación del plan de mercadeo digital, los objetivos de este deben estar alineados con los objetivos estratégicos de la marca/emprendimiento o empresa a nivel general. Para lograr esto, el método más certero es partir de los objetivos de negocio y “traducirlos” en objetivos digitales que aporten al logro de los objetivos generales. 
      br
      br
    ...
    p.mb-5 También existe el método SMART, que se define a continuación: 

    figure.col-xl-10.mx-auto.mb-5(data-aos="fade-left")
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/2L91WMqw96A" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)

    p.mb-5 Recuerde que establecer unos objetivos adecuados permite reaccionar ante estrategias o tácticas que no cumplen con las expectativas. Un ejemplo del método SMART sería el siguiente: “Aumentar en un 20% las reservas por redes sociales en el primer semestre del año”, entendiendo que:
    ...
    .d-flex.flex-wrap.mb-5
      ...
      img.order-1.order-lg-2.col-lg-6.col-xl-5.mb-4.mb-lg-auto.mx-auto.ms-xl-0(src="@/assets/curso/temas/tema1/img-3.svg" style="max-width: 497px" alt="imagen decorativa")

    p.mb-5 Se puede resumir, entonces, el método SMART en la siguiente fórmula, la cual es de gran utilidad para consolidar la planificación de los objetivos: 

    .d-flex.mb-5.justify-content-center
      h3.px-4.py-3(style="background-color: #B1DE19") Indicador + Parámetro + Dato + Métrica + Plataforma + Período
    ...
    .tabla-b.col-xxl-6.col-xl-8.col-lg-10.mx-auto.mb-5
